...
<head>
    ...
    <title>Portafolio Daniel Elias Alvarez Diaz</title>
        ...
        <section class="main-section">
            ...
            <div class="contenedores-section">
                ...
                <div class="contenedor-section">
                    ...
                    <ul>
                        <li class="chulo">UI Design</li>
                        <li class="chulo">web development</li>
                        <li class="cruz">logo design</li>
                        <li class="cruz">seo optimization</li>
                        <li class="cruz">wordPress integration</li>
                        <li class="cruz">5 Websites</li>
                        <li class="cruz">unlimited user</li>
                        <li class="cruz">20 gB bandwith</li>
                    </ul>
                ...
                <div class="contenedor-section">
                    ...
                    <ul>
                        <li class="chulo">UI Design</li>
                        <li class="chulo">web development</li>
                        <li class="chulo">logo design</li>
                        <li class="chulo">seo optimization</li>
                        <li class="cruz">wordPress integration</li>
                        <li class="cruz">5 Websites</li>
                        <li class="cruz">unlimited user</li>
                        <li class="cruz">20 gB bandwith</li>
                ...
                <div class="contenedor-section">
                    ...
                    <ul>
                        ...
                        <li class="chulo">logo design</li>
                        <li class="chulo">seo optimization</li>
                        <li class="chulo">wordPress integration</li>
                        <li class="chulo">5 Websites</li>
                        <li class="chulo">unlimited user</li>
                        <li class="chulo">20 gB bandwith</li>
                    </ul>
